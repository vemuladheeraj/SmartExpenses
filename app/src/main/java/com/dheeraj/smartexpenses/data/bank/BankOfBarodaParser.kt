...
/**
 * Parser for Bank of Baroda SMS messages
 * 
 * Supported formats:
 * - Debit: "Your Bank of Baroda a/c XX1234 has been debited Rs.500/-"
 * - Credit: "Your Bank of Baroda a/c XX1234 has been credited Rs.10000.00"
 * - UPI, IMPS, and other transaction types
 * 
 * Common senders: BARODA, BARODAB, variations with DLT patterns
 */
class BankOfBarodaParser : BankParser() {
    ...
    override fun canHandle(sender: String): Boolean {
        ...
        val barodaSenders = setOf(
            "BARODA",
            "BARODAB",
            "BARODABANK"
        )
        
        if (upperSender in barodaSenders) return true
        
        // Check for DLT patterns
        val dltPatterns = listOf(
            Regex("""BARODA[A-Z0-9]{6,}"""),
            Regex("""BARODAB[A-Z0-9]{5,}""")
        )
    ...
    override fun extractMerchant(message: String, sender: String): String? {
        ...
        // Try Bank of Baroda specific patterns
    ...
    override fun isTransactionMessage(message: String): Boolean {
        ...
        // Bank of Baroda specific transaction keywords
        val barodaTransactionKeywords = listOf(
            "debited", "credited", "withdrawn", "deposited",
            "spent", "received", "transferred", "paid", 
            "charged", "purchase", "deducted"
        )
        
        return barodaTransactionKeywords.any { lowerMessage.contains(it) }
    }
}