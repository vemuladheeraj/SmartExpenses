 ...
 * 
 * Supported formats:
 * - Debit: "Your PNB a/c XX1234 has been debited Rs.500/-"
 * - Credit: "Your PNB a/c XX1234 has been credited Rs.10000.00"
 * - UPI, IMPS, and other transaction types
 * 
 * Common senders: PNB, PNBB, variations with DLT patterns
 */
class PNBBankParser : BankParser() {
    ...
    override fun canHandle(sender: String): Boolean {
        ...
        val pnbSenders = setOf(
            "PNB",
            "PNBB",
            "PNBBANK"
        )
        
        if (upperSender in pnbSenders) return true
    ...
    override fun isTransactionMessage(message: String): Boolean {
        ...
        // PNB specific transaction keywords
        val pnbTransactionKeywords = listOf(
            "debited", "credited", "withdrawn", "deposited",
            "spent", "received", "transferred", "paid", 
            "charged", "purchase", "deducted"
        )
        
        return pnbTransactionKeywords.any { lowerMessage.contains(it) }
    }
}